...
- manual installation, OBS launch, legacy-task migration, WebDAV upload, verification-failure, local-move, and uninstall checks on a disposable Windows account;
